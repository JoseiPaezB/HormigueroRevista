...
const headNumbers = [1,2,3];
  ...
  return (
    <div className={`rotating-head-container ${className}`} style={{left:'50%',marginTop:'-30rem'}}>
      <img 
        src={`/assets/images/cerroDDD${currentHead}.png`}
